...
def baked_goods():
    if request.method == "GET":
        ...
        for backed_good in baked_goods:
            baked_goods_serialized.append(backed_good.to_dict())
        respose = make_response(jsonify(baked_goods_serialized) , 200)
        return respose
        ...
        respose = make_response( jsonify(new_baked_good_dict), 201)
        return respose
